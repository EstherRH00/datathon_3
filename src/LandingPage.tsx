...
function LandingPage() {
  ...
  return (
    <div className="m-5 bg-box-color p-5">
      ...
      <div className="bg-neutral-900 h-full w-full rounded-lg overflow-hidden overflow-y-auto flex items-center justify-center">
        <div className="flex items-center relative">
          <div className="w-2/3 relative">
            ...
            <button
              ...
              onClick={() => onClick("hospital10.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital11.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital12.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital13.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital14.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital15.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital16.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital17.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital18.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
            ...
            <button
              ...
              onClick={() => onClick("hospital19.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
          </div>
          ...
          <div className="w-1/3 relative">
            ...
            <button
              ...
              onClick={() => onClick("hospital20.csv")}
            >
              <img className="w-12 h-12" src={pin_hospital} alt="hospital" />
            </button>
          </div>
